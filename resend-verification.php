...
|--------------------------------------------------------------------------
| Connect this form to your backend handler.
| Recommended action:
| resend-verification-process.php
*/

$successMessage = $successMessage ?? '';
$errorMessage   = $errorMessage ?? '';
$oldEmail       = $oldEmail ?? '';
$cooldown       = isset($cooldown) ? max(0, (int) $cooldown) : 0;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
        ...
        <div class="card-content">
            ...
            <header class="card-header">
                ...
                <p>
                    ...
                    A new verification link will be sent to that address.
                </p>
            </header>
            ...
            >
                ...
                <p
                    class="cooldown-message <?= $cooldown > 0 ? 'visible' : '' ?>"
                    id="cooldownMessage"
                    aria-live="polite"
                >
                    Another email can be requested in
                    <strong id="countdown"><?= $cooldown ?></strong>
                    seconds.
                </p>
            </form>
            ...
            <div class="help-box">
                ...
                <span>
                    Check the spam or junk folder before requesting another
                    email. For privacy, the same confirmation message should
                    be shown whether the account exists or not.
                </span>
            </div>
    ...
    <script>
        ...
        let remainingSeconds =
            Number(resendButton.dataset.cooldown || 0);
