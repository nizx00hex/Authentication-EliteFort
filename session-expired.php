...
/*
|--------------------------------------------------------------------------
| End the expired session safely
|--------------------------------------------------------------------------
*/
...
<head>
    ...
    <meta name="description" content="The authenticated session has expired.">
...
<body>
    <main class="error-card">
        <section class="content-side">
            <div class="content">
                ...
                <p class="error-description">
                    The account was signed out because the authenticated session
                    ended or remained inactive for too long. Sign in again to
                    continue securely.
                </p>
                ...
                <div class="status-box">
                    ...
                    <span>
                        The expired session has been cleared from this browser.
                        Unsaved form information may need to be entered again.
                    </span>
                </div>

                <div class="actions">
                    <a href="login.php?session_expired=1" class="button button-primary">
                ...
                <p class="help-text">
                    Frequent session expiration may be caused by blocked cookies.
        ...
        <section class="visual-side" aria-label="Expired session illustration">
            ...
            <p class="visual-caption">
                The previous authenticated session is no longer valid.
            </p>
        </section>
    </main>
</body>
